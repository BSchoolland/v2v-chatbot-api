...
async function logToolCall(toolName = "", success = false, params = "", result = "", metadata = {}) {
    try {
        ...
        await dbRun('INSERT INTO tool_calls (timestamp, tool_name, success, arguments, result, chatbot_id, message_id) VALUES (?, ?, ?, ?, ?, ?, ?)', [timestamp, toolName, success, arguments, result, metadata.chatbotId, metadata.messageId]);
